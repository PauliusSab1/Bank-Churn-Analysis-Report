...
<img width="350" height="450" alt="image" src="https://github.com/user-attachments/assets/65971d9e-68a8-4d1d-86e6-8d6209f661b6" />
...
-	Churn rate by education indicates similar rate for customers with **high school (31%)**, **masters (32%)** and **bachelor’s diploma (33%)**. On the other hand, clients with **PhD education** are more likely to churn **(40%)**.  
...
-	Credit scores can be a big indicator for potential churned customers. We divided customers to four different credit bands: poor credit (lower than 500 points), fair credit (500- 650 points), good credit (650-750 points), and excellent credit (750+).   
...
-	Customers with fair, good and excellent credit scores have similar churn rates and varies only by **0.6-1.8%**.
...
**Business Problem:** Customers with short tenure (0-12months) show significantly higher churn – especially when combined with inactivity (47% churn rate). 
...
**Business Problem:** Customers inactive for 5+ months are more likely to get churned by 15-18%.
...
**Business Problem:** Customers with excellent credit score and 4 products churn at a much lower rate (23%) compared to average number (32%) 
...
**Business Problem:** Customers with poor credit scores (39% churn rate) and low engagement (44% churn rate) represent the highest churn risk. 
